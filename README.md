...
[![My Skills](https://skillicons.dev/icons?i=html,css,java,js,nodejs,vuejs,jquery,php,mysql,git,c,cpp,python,laravel,vscode,linux,postman,arduino,typescript,bash)](https://skillicons.dev)
